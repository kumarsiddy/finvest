...
class AccountPendingVerificationPopover extends StatelessWidget {
  const AccountPendingVerificationPopover({Key? key}) : super(key: key);
    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
        ...
        children: [
          ...
          Text(
            "We need a few more details to activate your account."
