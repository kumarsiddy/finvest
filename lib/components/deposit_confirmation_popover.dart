...
class DepositConfirmationPopover extends StatelessWidget {
  const DepositConfirmationPopover(
      {super.key, required this.depositAmount, this.transaction});
    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
        ...
        children: [
          ...
          Text(
            "Your ${formatAmount(depositAmount)} transfer from your bank has been initiated."
